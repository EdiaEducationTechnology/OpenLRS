...
public class StatementController {
  ...
  @Autowired
  public StatementController(XApiService xapiService, ObjectMapper objectMapper, Validator validator) {
   ...
   */
  @RequestMapping(method = RequestMethod.GET, produces = "application/json;charset=utf-8", params = "!statementId")
  public StatementResult getStatement(@RequestParam(value = "actor", required = false) String actor,
      @RequestParam(value = "activity", required = false) String activity, @RequestParam(value = "since", required = false) String since,
      @RequestParam(value = "until", required = false) String until, @RequestParam(value = "limit", required = false) String limit) {
